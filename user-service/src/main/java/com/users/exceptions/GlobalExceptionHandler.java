...
/**
 * Traduit les exceptions métier et techniques en réponses HTTP {@link ApiError}.
 * C'est le seul point du service où la couche web connaît les exceptions.
 */
...
public class GlobalExceptionHandler {
	...
	public ApiError handleInvalidCredentials(InvalidCredentialsException ex) {
		...
		return ApiError.of(HttpStatus.UNAUTHORIZED, ex.getMessage());
	}
